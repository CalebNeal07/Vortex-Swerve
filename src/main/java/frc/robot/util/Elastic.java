...
/**
 * Class to implement Elastic's Alert's system, derived from 6328's initial shuffleboard
 * implementation. Documentation can be found <a
 * href="https://frc-elastic.gitbook.io/docs/additional-features-and-references/robot-notifications-with-elasticlib">here</a>.
 *
 * @version git-commit: 8a28b83
 */
